...
public class BlankFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        btnGoEnd=view.findViewById(R.id.btn_go_first);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_go_first:
               // navController.navigate(R.id.action_blankFragment_to_addNoteFragment);


                if (getArguments()!=null){

                    BlankFragmentArgs args=BlankFragmentArgs.fromBundle(getArguments());
                    txtShow.setText(args.getData()+" % --> Number ");

                    Log.e(TAG, "onClick: "+args.getModel().toString());
                    Log.e(TAG, "onClick getName : "+args.getModel().getName());
                    Log.e(TAG, "onClick getFamily : "+args.getModel().getFamily());
